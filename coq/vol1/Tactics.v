...
Proof.
  ...
  induction l as [| y l'].
  - discriminate.
  - intros. destruct (test y) eqn:E.
    + simpl in H. rewrite E in H. injection H as H1 H2. rewrite H1 in E. apply E.
    + simpl in H. rewrite E in H. apply IHl' in H. apply H. Qed.
...
Proof.
  ...
  induction l as [| x l'].
  - reflexivity.
  - simpl. rewrite IHl'. destruct (test x) eqn:E.
    + simpl. unfold existsb'. simpl. rewrite E. reflexivity.
    + simpl. unfold existsb'. simpl. rewrite E. reflexivity. Qed.
(** [] *)
