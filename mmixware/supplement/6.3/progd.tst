...
1H	STOU	avail,$1
	...
	SUB	$3,$3,1
	LDO	$1,data
	SLU	$1,$1,(64-:bits)	we use the upper 16 bit left aligned
	STO	$1,Head+16
	
1H	LDA	$5,Head
	LDO	$6,$2,0
	SLU	$6,$6,(64-:bits)	we use the upper 16 bit left aligned
...
2H	LDA	$8,Head
	LDO	$9,$5,0
	SLU	$9,$9,(64-:bits)	we use the upper 16 bit left aligned
	PUSHJ	$7,Search
...
[[SET Runtime 
	SET	$0,0
	[[INCLUDE runtime.mms :Rtotal $0 463 0]]
]]
...
[[SET Runtime 
	SET	$0,0
	[[INCLUDE runtime.mms :Rtotal $0 74141 0]]
]]
...
[[SET Runtime 
	SET	$0,0
	[[INCLUDE runtime.mms :Rtotal $0 958187 0]]
]]
